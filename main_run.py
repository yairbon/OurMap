...
memories = [
    ...
    [32.12301749051284, 34.796344793133535,"הבית של מאמצ'י", "מאוד כיף בבית שלך מאמי",'https://github.com/yairbon/OurMap/blob/main/images/CopFlower.png?raw=true'],
    ...
    [32.820690877304, 34.990943482725534,"קריסמס בחיפה","אז.... מי לא אוהב קריסמס? אני? את? או שבעצם כולם",'https://github.com/yairbon/OurMap/blob/main/images/mess.png?raw=true'],
